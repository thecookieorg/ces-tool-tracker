...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { city: @tool.city, date_in: @tool.date_in, date_out: @tool.date_out, person_name: @tool.person_name, tool_name: @tool.tool_name }
    end
  ...
  test "should update tool" do
    patch :update, id: @tool, tool: { city: @tool.city, date_in: @tool.date_in, date_out: @tool.date_out, person_name: @tool.person_name, tool_name: @tool.tool_name }
    assert_redirected_to tool_path(assigns(:tool))
  end
